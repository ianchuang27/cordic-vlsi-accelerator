...
# Reports
report_timing -max_paths 10 > results/timing_pipelined_2ns.rpt
report_area -hierarchy > results/area_pipelined_2ns.rpt
report_power -hierarchy > results/power_pipelined_2ns.rpt
report_constraint -all_violators > results/constraints_pipelined_2ns.rpt
report_qor > results/qor_pipelined_2ns.rpt
report_resources > results/resources_pipelined_2ns.rpt

# Save outputs
write -format verilog -hierarchy -output results/cordic_pipelined_netlist_2ns.v
write -format ddc -hierarchy -output results/cordic_pipelined_2ns.ddc
